...
% Different algorithm environments (algorithmic, algorithmicx + algpseudocode, algorithm2e) -> https://tex.stackexchange.com/questions/229355/algorithm-algorithmic-algorithmicx-algorithm2e-algpseudocode-confused/230789#230789
%\RequirePackage{algorithmic}
%\RequirePackage[algo2e,boxed]{algorithm2e}
\RequirePackage{algpseudocode}  % Cannot be included at the same time as package "algorithmic" or "algorithm2e".  % With algpseudocode (which uses algorithmicx), line breaks do not preserve indentation... (e.g. collective detection receiver)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Identifiability in Transformers %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Meaningful log messages for changing labels
%   Prints "label XYZ changed: ..."
%   From https://tex.stackexchange.com/questions/154594/how-to-diagnose-a-permanent-labels-may-have-changed-warning
\def\@testdef #1#2#3{%
...
%\chapterstart
\include{./chapters/0.4.acknowledgements}
