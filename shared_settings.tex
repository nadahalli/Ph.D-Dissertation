...
The thesis covers certain attacks and possible solutions in the w.r.to privacy, censorship resistance, and scalability of the Bitcoin ecosystem. The thesis presents novel transaction constructions that enable these solutions. It also presents an attack on certain DeFi protocols that rely on on-chain oracles. These attakcs show that designing such systems in expressive smart contract platforms is inherently challenging.
}
